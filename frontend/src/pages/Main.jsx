...
import CreateSubject from "../components/modals/CreateClassroom";
import JoinClassrooms from "../components/modals/JoinClassrooms";
        ...
        <div className="navbar text-sm md:text-base p-2 flex justify-between w-full overflow-x-hidden items-center">
          ...
          <div className="middle flex items-center gap-4 justify-center">
            ...
            {!user ? (
              ...
              <Link
                to={"/auth/login"}
                className="bg-primary happy-font font-bold text-white rounded-2xl p-2"
              >
                dashboard
              </Link>
            )}
